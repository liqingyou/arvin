...
export const SITE = {
  title: '博客',
  author: 'Liquor',
  description: '记录 Liquor 的不枯燥生活',
  profileContent: '我是Liquor，目前生活在秦皇岛的开发者。',
  keywords: 'Liquor, Blog, 前端, Vue, 博客',
...
export const bentoCommonComponentsCfg = [
  ...
  { id: 'Weekly', x: 2, y: 2, width: 2, height: 1, index: 0 },
  { id: 'WeeklyZhiBan', x: 2, y: 2, width: 2, height: 1, index: 0 },
  ...
  { id: 'CountDownDay', x: 3, y: 1, width: 2, height: 1, index: 0 },
